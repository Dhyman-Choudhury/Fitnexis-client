    ...
    return (
        <div className="night_text table_bg min-h-screen py-10">
            <div className="max-w-3xl mx-auto p-6 bg-gray-200 rounded-2xl shadow">
                <h2 className="text-3xl md:text-4xl font-bold mb-10 text-center">Add New Slot</h2>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="input input-bordered w-full px-3 py-4 bg-white border border-gray-300 rounded-lg mb-3"
                            />
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className="select select-bordered w-full bg-white px-3 py-2 rounded-lg border border-gray-300"
                        >
